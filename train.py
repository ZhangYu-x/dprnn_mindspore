...
parser.add_argument('--lr1', default=0.0005, type=float,
                    help='Init learning rate')
parser.add_argument('--lr2', default=0.00025, type=float,
                    help='Init learning rate')
parser.add_argument('--lr3', default=0.000125, type=float,
                    help='Init learning rate')
...
# save and load model
parser.add_argument('--save_folder', default='/home/heu_MEDAI/commit910/ckpt',
